...
const DEFAULT_BACKDROP_URL = "resources/images/Movies/interstellar_wide_357x1400.jpeg";
const BASE_CASTPOSTER_URL = "https://image.tmdb.org/t/p/original";
const DEFAULT_CASTPOSTER_URL = "resources/images/Movies/interstellar_wide_357x1400.jpeg";
...
function processSearch(results, type, query) {
    ...
    if (query == 'search') {
        ...
        let cast = 0;
        // castPosters = [movieCastPoster1, movieCastPoster2, movieCastPoster3];
        for (let i = 0; i <= 2; i++) {
            let castPoster;
